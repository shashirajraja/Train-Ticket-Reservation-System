...
STEP 2: RIGHT CLICK ON PROJECT > BUILD PATH > CONFIGURE BUILD PATH > LIBRARIES > UPDATE ANY LIBRARIES WITH RED MARK > ADD LIBRARY > JRE SYSTEM LIBRARY > NEXT > SELECT WORKSPACE DEFAULT JRE >FINISH
